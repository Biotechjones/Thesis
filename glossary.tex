...
% \DeclareAcronym{ANOVA}{Analysis of Variance\acroextra{, a set of
%   statistical techniques to identify sources of variability between groups}, 
%   short = anova}
% \DeclareAcronym{API}{long = application programming interface, 
% short = ap}
% \DeclareAcronym{CTAN}{long = \acroextra{The }Common \TeX\ Archive Network, 
% short = ctan}
% \DeclareAcronym{DOI}{long = Document Object Identifier\acroextra{ (see
%     \url{http://doi.org})}, 
%     short = doi}
% % \DeclareAcronym{GPS}[GPS]{Graduate and Postdoctoral Studies, 
% short = gps}
% \DeclareAcronym{PDF}{long = Portable Document Format, 
% short = pdf}
% % \DeclareAcronym{RCS}[RCS]{Revision control system\acroextra{, a software
%     tool for tracking changes to a set of files}, 
%     short = rcs}
% % \DeclareAcronym{TLX}[TLX]{Task Load Index\acroextra{, an instrument for gauging
%   the subjective mental workload experienced by a human in performing
%   a task}, 
%   short = tlx}
% \DeclareAcronym{UML}{long = Unified Modelling Language\acroextra{, a visual language
%     % for modelling the structure of software artefacts}, 
%     short = uml}
% % \DeclareAcronym{URL}{long = Unique Resource Locator\acroextra{, used to describe a
%     means for obtaining some resource on the world wide web}, 
%     short = url}
% % \DeclareAcronym{W3C}[W3C]{\acroextra{the }World Wide Web Consortium\acroextra{,
