...
%%
\title{The structure and composition of the cell envelope from \textit{Caulobacter crescentus}}
...
%% subsetsof your thesis (e.g., for committee members who want to see
%% the dissertation chapter by chapter).  It also saves time by 
%% avoiding reprocessing the entire file.
%\includeonly{intro,conclusions}
\includeonly{crystal_chapter/crystal, lps_chapter/lps, porin_chapter/porin}
