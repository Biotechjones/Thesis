...
\DeclareAcronym{llhep}{
    short = LLHep,
    long = \textsc{l}-\textit{glycero}-\textsc{l}-\textit{manno}heptose,
    class = sugar
}
\DeclareAcronym{ldhep}{
    short = LDHep,
    long = \textsc{l}-\textit{glycero}-\textsc{d}-\textit{manno}heptose,
    class = sugar
}
...
\DeclareAcronym{kdo}{
    short = Kdo,
    long = 3-deoxy-\textsc{d}-\textit{manno}octulosonic acid, 
    class = sugar
}
...
\DeclareAcronym{cls}{
    short = cls,
    % extra = a synchotron in Saskatoon Saskatchewan,
...
\DeclareAcronym{ssrl}{
    ...
    % extra = a synchotron in Palo Alto California,
    short-format = \scshape 
}
\DeclareAcronym{rtx}{
    short = rtx,
...
\DeclareAcronym{salmonella}{
     short = S. enterica ,
    long = \textit{Salmonella enterica} var.~Typhimurium , 
    short-format = \itshape , 
    class = bacteria
}
\DeclareAcronym{pma}{
...
\DeclareAcronym{SAD}{
    short = sad ,
    long = single-wavelength anomalous dispersion, 
    short-format = \scshape 
}
\DeclareAcronym{MAD}{
    short = mad ,
    long = multi-wavelength anomalous dispersion, 
    short-format = \scshape 
}
\DeclareAcronym{jcsg}{
    short = jcsg ,
    long = Joint Centre for Structural Genomics, 
    short-format = \scshape 
} 
\DeclareAcronym{mamp}{
    short = mamp ,
    long = microbe-associated molecular pattern, 
    % extra = aka pathogen-associated molecular pattern,
    short-format = \scshape 
}
\DeclareAcronym{tlr4}{
    short = tlr4 ,
...
\DeclareAcronym{dmem}{
    short = dmem ,
    long = Dulbecco’s modified Eagle’s medium, 
    short-format = \scshape 
}