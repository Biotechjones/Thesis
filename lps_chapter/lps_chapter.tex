...
\label{sec:results}
	...
	\label{sub:rhamnan_polysaccharide_determination_ps2_}
		...
		\begin{table}[h]
			\centering
			\caption{\ac{NMR} data for \caulobacter  \ac{PS}2 and its \ce{NaIO4} oxidation product \ac{OS}1 (40\cel).}
	...
	\label{sub:core_oligosaccharide_determination}
		...
		\begin{table}[htb]
			\centering
			\caption{\ac{NMR} data for the core oligosaccharide (25\cel).}
			\label{tbl:lpstable4}
