...
The \caulobacter{} \ac{LPS} was isolated from \caulobacter{} JS1013, a derivative of NA1000. The \ac{LPS} isolation protocol can be found \vpageref{sub:LPS_isolation}. The \ac{salmonella} \ac{LPS} was \ac{salmonella} serotype minnesota Re 595 and it was purchased from Sigma-Aldrich.
...
Kits for assaying various cytokine were purchased from Meso Scale Discoveries: \ac{tnfa}, a proinflammatory cytokine released by macrophages in response to \ac{LPS}\upcite[]{wajant2003tumor}; \ac{il} 6, an important cytokine for generating adaptive immunity\upcite[]{scheller2011pro}; \ac{il} 10, an anti inflammatory signal,``Master Regulator of Immunity to Infection''\upcite[]{couper200810}; and \ac{mcp1}, a key chemokine for macrophage trafficking\upcite[.]{deshmane2009monocyte} The assays were done following the supplier's instructions and the data readouts were produced on a QuickPlex SQ 120 imager (courtesy of the Pfieffer lab, UBC).
% section methods (end)
