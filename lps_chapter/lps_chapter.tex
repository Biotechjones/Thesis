...
Kits for assaying \ac{tnfa}, \ac{il} 6, \ac{il} 10, \ac{mcp1}, and \ac{ifnb} were purchased from Meso Scale Discoveries. The assays were done following the supplier's instructions and the data readouts were produced on a QuickPlex SQ 120 imager (courtesy of the Pfieffer lab, UBC).
% section methods (end)
