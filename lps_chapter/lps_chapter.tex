...
\label{sec:methods}
	...
	\label{sub:LPS_isolation}
		...
		\ac{LPS} was isolated from the cells via disrupting the outer membrane by chelation.
		 The the negative charges in Gram negative bacterial \ac{LPS} are stabilised and bridged by available divalent cations (\ie{} \ce{Ca^2+} and \ce{Mg^2+}). Lieve %^ Add Citation and correct author
		 first noted in 1965 %^ Citation to Lieve 65!
