...
Caulobacter crescentus (\acs{caulobacter}) is an aquatic alphaproteobacterium
...
All samples were boiled for 5 minutes in sample buffer prior to applying them to gel. Sample buffer is made as a 4X concentrate comprising 200 mM Tris pH 6.8, 8\% sodium dodecylsulfate, 40\% glycerol, 4\% $\beta$-mercaptoethanol, 0.25\% bromophenol blue.
		...
		\begin{table}[p]  % Silver stain table
			\centering
...
\begin{figure}[p] %% monosaccharides
  \begin{center}
...
known mechanism for the regulation and synthesis of a strictly homogeneous length \ac{OPS}. Another example of a homogenous length \ac{OPS} is \textit{Aeromonas hydrophila} AH-1\upcite[.]{merino2015molecular}
