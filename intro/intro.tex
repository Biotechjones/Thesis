...
\subsection{S-layer structure} \label{sub:s_layer_structure} 
Cellular envelopes are the interface between a
...
\begin{figure}[p] % S-layer symmetries
  \begin{center}
...
% subsection s_layer_structure (end) 
  ...
  The \ac{aeromonas} \ac{S-layer} is sufficient to confer host cell adhesion to the bacterial cells and also to nylon microbeads \textit{in vitro} that have been coated with the \ac{aeromonas} \ac{S-layer} protein, VapA. 
