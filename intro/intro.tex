...
Interestingly, \textit{Bacillus brevis} appears to have two \acp{S-layer} stacked on top of each
...
\textit{Lactobacillus brevis}\upcite[.]{masuda1980reassembly} Examples of bacteria with rectangular
\acp{S-layer} are \textit{Corynebacterium diphtheriae}e\upcite{kawata1972extracellular} and
