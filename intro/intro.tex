...
\label{ch:Introduction}
    ...
    \label{sec:s_layer_structure}
        ...
        \end{figure}
            ...
            Examples of bacteria with hexagonal \acs{S-layer} are \textit{Bacillus anthracis}\upcite{holt1969comparative} and \textit{Caulobacter crescentus} CB15\upcite[.]{smit1981periodic}
