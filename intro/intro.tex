...
streptococci\upcite[]{griffith1928significance} and mycolic acids increase resistance to antibiotics for mycobacteria\upcite[.]{nguyen2006foundations} One such
...
archaea. \Cref{fig:cellwalls} shows the general, cross-sectional structure of
...
techniques historically to see \acp{S-layer} and \ac{S-layer} geometries\upcite[.]{smit1981periodic} The discovery of \acp{S-layer} and the first image of an \ac{S-layer}
published was produced by electron microscopy\upcite[.]{firstslayer} That first \ac{S-layer} image can be seen in \cref{fig:firstslayer}. For a historical overview
...
\label{sec:bacterial-examples}
The five major geometric symmetries found in \acp{S-layer} are oblique (P1 and P2), triangular (P3), tetragonal (P4), and hexagonal (P6). \Cref{fig:symmetries} features simple
...
NRS2004$/$3a\upcite{messner1986characterization} and \textit{Brevibacillus
  (Lactobacillus) brevis}\upcite[.]{masuda1980reassembly} Examples of bacteria with tetragonal \acp{S-layer} are
\textit{Corynebacterium diptheriae}\upcite{kawata1972extracellular} and \acl{aeromonas} A450\upcite[.]{ishiguro1981loss} An example of a bacterium with a triangular \ac{S-layer}
...
\cpageref{sec:bacterial-examples}}
...
Dr./,Sriram Subramaniam at the National Cancer Institute. \Cref{fig:intro-tomo}
...
hydrophobic and negatively charged residues, low in methionines, and cysteines are almost completely absent\upcite[.]{gilchrist1992nucleotide, sara2000s, vilen2009surface}
...
\ac{S-layer} proteins are almost universally glycosylated in archaea, commonly glycosylated in Gram-positive bacteria, and very rarely glycosylated in
...
Related?''\upcite[]{schaffer1996s} The study identified structural similarities
...
upon a nanoparticle. For instance, \caulobacter \ac{S-layer} can be reassembled on to lipid vesicles containing \caulobacter{} \ac{LPS}\upcite[.]{nomellini1997factors}
  ...
  Two good reviews on the subject of \ac{S-layer} applications were written by Smit (2008)\upcite[]{smit2008heads} and Ilk, Egelseer, and Sleytr (2011)\upcite[.]{ilk2011s}  The
...
minnesota}, see \cref{fig:lpsoverview}) and glucosamine (\eg \textit{Bordetella pertussis}\upcite[]{marr2008glucosamine}). Neutral attachments to the phosphate are also possible
...
One of the most extreme modifications to the diglucosamine backbone is the unique example of \textit{Rhizobium leguminosarum}\upcite[.]{bhat1994structure} \textit{R. leguminosarum}'s lipid
...
are replaced with \textsc{d}-mannose moieties\upcite[.]{fromkoval} 
...
as much as in other lipids due to more stringent acyltransferases, but they do vary among bacteria\upcite[.]{wyckoff1998hydrocarbon} An extreme example is the 28 carbon long acyl
...
was identified before the molecule was isolated\upcite[,]{zinsser1913anaphylatoxins} giving \ac{LPS} its alternate, original name ``endotoxin''.
...
excellent papers and reviews on the immunological aspects of lipid A. The review by Alexander and Rietschel (2001)\upcite[]{alexander2001invited} is a good general review of the
...
In the immune system, two proteins, \ac{LPS}-binding protein and \textsc{cd}14,
...
\ecoli\upcite[.]{ecolioantigens} \Cref{fig:lpsoverview} shows the \ac{LPS} from \textit{S. minnesota}; its core oligosaccharide has many ``canonical'' features (\eg Kdos, heptoses,
...
\textit{V. cholerae}\upcite[]{kenne1982structural}). There are also  \acp{OPS} in \ecoli that are comprise a single repeating sugar (O8, O101) but they have multiple
...
\Acp{OPS} can be synthesized from a large range of sugars. Well known sugars, such as glucose and mannose are regular components of \acp{OPS} but so are rare sugars such as talose,
...
The Wzy-dependent pathway is the classic subunit based synthesis pathway for \acp{OPS}. The subunits, consisting of 2--7 sugars, are assembled on a undecaprenyl-pyrophosphate
...
synthesis. \Cref{fig:lpswzy} is an overview of this pathway. \Acp{LPS} with
...
of one \ac{OPS} subunit. \Cref{fig:lpssilverstain} has an example of that
...
Silhavy (2009) covers the subject of \ac{LPS} transport\upcite[.]{ruiz2009transport} \Cref{fig:lpstransport} is an overview of \ac{LPS} transport across the periplasm.
...
membrane proteins\upcite[,]{caulobactergenomeseq}
possibly as an adaptation to living in nutrient poor
environments\upcite[.]{lohmiller2008tonb} TonB-mediated transport systems
utilize energy consumed at the inner membrane to power specific uptake systems
in the outer membrane. \Cref{fig:porinvstonb} illustrates TonB-mediated
...
\cref{ch:porin} for our work to characterize OmpW in \caulobacter{}.
 ...
 \section{Aims and Objectives}\label{sec:summary} The bacterium \caulobacter is a well studied model organism for its dimorphic life cycle\upcite[,]{skerker2004cell} cell
