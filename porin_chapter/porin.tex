...
The enriched outer membranes were treated with 0.5\% \ac{LDAO}. When small amounts of this detergent extract of the outer membranes was added to one or both sides of a black \ac{PC}/n-decane membrane a remarkable increase of membrane conductance was observed, indicating that the enriched outer membranes contained membrane-active components. %%The conductance increase was not sudden, but delayed after addition of the extract. 
